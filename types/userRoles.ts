...
export const ROLE_DEFINITIONS: Record<UserRole, RoleDefinition> = {
  admin: {
    ...
    permissions: {
      ...
      canViewOwnSalesMetrics: true,
      canManageOwnPipeline: true,
  ...
  accountant: {
    ...
    permissions: {
      ...
      canViewOwnSalesMetrics: false,
      canManageOwnPipeline: false,
  ...
  salesperson: {
    role: 'salesperson',
    label: 'Salesperson',
    description: 'Sales team member with pipeline and customer management',
    permissions: {
      canCreate: false,
      canEdit: false,
      canDelete: false,
      ...
      canSendProposals: true,
      canViewPipeline: true,
      canEmailCustomers: false, // Level 2 only
    },
  },
};
...
// Permission levels for salesperson
export const SALESPERSON_PERMISSION_LEVELS: Record<SalespersonPermissionLevel, UserPermissions> = {
  1: {
    // Level 1: Basic salesperson
    canCreate: false,
    canEdit: false,
    canDelete: false,
    canView: false,
  ...
  2: {
    // Level 2: Salesperson with customer communication
    canCreate: false,
    canEdit: false,
    canDelete: false,
    canView: false,
    ...
    canSendProposals: true,
    canViewPipeline: true,
    canEmailCustomers: true,      // Added in Level 2
  },
  3: {
    // Level 3: Reserved for future expansion
    canCreate: false,
